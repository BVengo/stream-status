...
# Add teams and ability to see invisible teammates
team add ss_afk {"text":"AFK", "color":"gray"}
team add ss_recording {"text":"Recording", "color":"red"}
team add ss_recording_afk [{"text":"Recording ", "color":"red"}, {"text":"AFK","color":"gray"}]

team modify ss_afk seeFriendlyInvisibles false
...
team modify ss_afk prefix {"text":"●", "color":"gray"}
team modify ss_recording prefix {"text":"●", "color":"red"}
team modify ss_recording_afk prefix [{"text":"●", "color":"gray"}, {"text":"●", "color":"red"}]
